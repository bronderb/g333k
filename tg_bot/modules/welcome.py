        ...
        for new_mem in new_members:
            ...
            # Give start information when add bot to group
                ...
                if sql.welcome_security(chat.id) == "hard":
                    update.effective_message.reply_text("Hi {}, this group is  protected against spambots. Please click on the button below to be unmuted.".format(new_mem.first_name), 
